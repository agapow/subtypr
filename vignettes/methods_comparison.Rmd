...
We also use PINSPlus via `subtype_pins()` with the `gbm_data`.

We proceed in three parts to show different ways to use the package:

* analyze the behaviour of methods on unstructured data
* compare methods on structured synthetic data with a ground-truth
